    ...
    return (
      <ResponsiveContainer width="100%" height={height}>
        <AreaChart data={data} margin={{ top: 10, right: 12, left: 0, bottom: 0 }}>
          ...
          <YAxis tickFormatter={(v) => formatNumber(v as number)} width={50} />
          <Tooltip
